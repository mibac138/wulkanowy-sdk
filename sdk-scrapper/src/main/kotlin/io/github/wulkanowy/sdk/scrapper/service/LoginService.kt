...
internal interface LoginService {
    ...
    @GET
    suspend fun getModuleStart(@Url url: String): Response<String>

    @POST
    @FormUrlEncoded
    suspend fun sendCertificateModule(@Header("Referer") referer: String, @Url url: String, @FieldMap certificate: Map<String, String>): Response<String>
